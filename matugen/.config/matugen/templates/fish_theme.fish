...
# preferred_background: {{colors.primary.default.hex }}
...
set fish_color_option {{colors.source_color.default.hex_stripped}}
set fish_color_param {{colors.source_color.default.hex_stripped}}
set fish_color_quote {{colors.secondary.default.hex_stripped}}
set fish_color_redirection {{colors.source_color.default.hex_stripped}}
