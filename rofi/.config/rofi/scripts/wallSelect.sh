...
notify-send --app-name="Hyprsphere" -t 3000 "Hyprsphere" "Cambiando fondo de pantalla" --icon="$HOME/.dotfiles/logo-hyprsphere-min.png"
matugen image ${wall_dir}/${wall_selection}
notify-send --app-name="Hyprsphere" -t 3000 "Hyprsphere" "Fondo de pantalla seleccionado aplicado" --icon="$HOME/.dotfiles/logo-hyprsphere-min.png"
