hl.define_submap("resize", function()
  ...
  hl.bind("down", hl.dsp.window.resize({ x = 10, y = -10, relative = true }),
  ...
  hl.bind("K", hl.dsp.window.resize({ x = 0, y = 10, relative = true }),
    { repeating = true, description = "Aumentar alto" })
  hl.bind("J", hl.dsp.window.resize({ x = 10, y = -10, relative = true }),
    { repeating = true, description = "Reducir alto" })

  -- Use `reset` to go back to the global submap
  hl.bind("escape", hl.dsp.submap("reset"), { description = "Salir del modo redimensionar" })
end)
...
hl.define_submap("Multimedia", function()
  ...
  hl.bind("escape", hl.dsp.submap("reset"), { description = "Salir del modo multimedia" })
end)

hl.define_submap("Passthrough", function()
  hl.bind("escape", hl.dsp.submap("reset"), { description = "Salir del modo passthrough (recuperar control)" })
end)
