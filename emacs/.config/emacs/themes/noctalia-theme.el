...
(let* ((bg "#161215")
      ...
      (on-background "#eae0e3")
      (on-err "#690005")
      (on-err-container "#ffdad6")
      (on-primary "#58124b")
      (on-primary-container "#ffd7ef")
      (on-secondary "#3e2a38")
      (on-secondary-container "#fadaec")
      (on-surface "#eae0e3")
      (on-surface-variant "#d2c2ca")
      (on-tertiary "#4b2716")
      (on-tertiary-container "#ffdbcd")
      (outline-color "#9b8d94")
      (outline-variant "#4f444a")
      (primary "#ffade5")
      (primary-container "#732b63")
      (secondary "#ddbed0")
      (secondary-container "#56404e")
      (shadow "#000000")
      (surface "#161215")
      (surface-container "#231e21")
      (surface-container-high "#2e292b")
      (surface-container-highest "#393336")
      (surface-container-low "#1f1a1d")
      (surface-container-lowest "#110d0f")
      (surface-variant "#4f444a")
      (tertiary "#f5b9a1")
      (tertiary-container "#663c2b")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f5b9a1")
      (on-success "#4b2716")
      (success-container "#663c2b")
      (on-success-container "#ffdbcd")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffade5")
      (primary-fixed-dim "#732b63")
      (secondary-fixed "#ddbed0")
      (secondary-fixed-dim "#56404e")
      (tertiary-fixed "#f5b9a1")
      (tertiary-fixed-dim "#663c2b")
      (on-primary-fixed "#58124b")
      (on-primary-fixed-variant "#ffd7ef")
      (on-secondary-fixed "#3e2a38")
      (on-secondary-fixed-variant "#fadaec")
      (on-tertiary-fixed "#4b2716")
      (on-tertiary-fixed-variant "#ffdbcd")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#eae0e3")
      (inverse-primary "#ffade5")
      (inverse-surface "#161215")
