...
Cambia el idioma de autocorrectivo, de un documento org dependiendo de la etiqueta =#+language:= que se le haya introducido
#+begin_src emacs-lisp
...
#+begin_src bash
sudo pacman -S poppler ffmpegthumbnailer mediainfo libvips 7zip imagemagick
#+end_src
*** Dired sidebar
#+begin_src emacs-lisp
