...
Variables de entorno que al establecerlas me permiten funcionar mejor en el editor
#+begin_src emacs-lisp
(setenv "DISPLAY" ":0")
#+end_src
...
#+end_src
** Defmenu
Nos permite definir un menu a partir de rofi que se ejecuta desde emacs
#+begin_src emacs-lisp
