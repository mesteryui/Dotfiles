...
Me he inspirado en lo que voy a hacer para mi distribución Emacs llamada Nox
#+begin_src emacs-lisp
...
#+end_src
*** Configuraciones de tema 'archivadas'
...
Este codigo es util ya que así puedo usar el valor de una macro en otra macro que use Emacs Lisp en orgmode
#+begin_src emacs-lisp
...
* Paquetes
** Tramp
Ya viene con Emacs aqui defino unas configuraciones 
#+begin_src emacs-lisp
(use-package tramp
  :ensure nil
  :custom
