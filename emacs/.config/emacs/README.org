...
:PROPERTIES:
:header-args:emacs-lisp: :tangle "modules/performance.el"
:END:
...
(os/after cosmos-dashboard
   (setq cosmos-dashboard-show-modeline t))
#+end_src
**** Os scratch
...
#+end_src
** VC
Todo lo relacionado al tema del control de versiones.
*** VC Jujutsu
#+begin_src emacs-lisp 
(use-package vc-jj
  :ensure t)
