...
(when (fboundp 'native-compile-set-strict-mode)
  ;; 1. Compilación nativa en background para no bloquear Emacs.
  (setq native-comp-async-report-warnings-p nil)
  (setq native-comp-deferred-compilation-deny-list '("."))
  
  ;; 2. Ajustes de la compilación en caliente (compilación JIT de Lisp)
  (setq native-comp-deferred-compilation-inhibit-p nil)
  (setq native-comp-speed 3)
  
  ;; 3. Activa la compilación asíncrona por si acaso.
  (setq native-comp-async-p t))
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
#+end_src
*** Time
Aqui añado configuraciones para el reloj en Emacs, así puedo estar al tanto de la hora en otras zonas horarias es util si haces necesitas comunicarte con gente de diferentes zonas horarias.
#+begin_src emacs-lisp
...
(use-package org-alert
  ...
  (setq org-alert-times '(1 10 30 1440 2880))
