...
(display-time-mode 1)
#+end_src
**** Cosas para mejorar el asunto del texto
Aquí procederemos a configurar mixed-pitch para aseguar que emacs se vea genial
#+begin_src emacs-lisp :tangle no
