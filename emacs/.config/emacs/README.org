...
Aqui cargaremos algunos scripts básicos como el usado para elpaca
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (setq read-process-output-max (* 4 1024))  ; Establece el valor a 4k
#+end_src
...
#+END_SRC
** Projectile
Es un sistema para gestionar proyectos desde *Emacs*
#+begin_src emacs-lisp
...
#+end_src
** Typst
Es un sustituto de LaTeX con una sintaxis más simple
#+begin_src emacs-lisp
