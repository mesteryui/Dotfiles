...
- [[#paquetes-diversos][Paquetes diversos]]
  ...
  - [[#sudo-edit][Sudo edit]]
  - [[#adaptative-wrap][Adaptative wrap]]
...
#+end_src
* Org Mode
Estas son configuraciones básicas para el org-mode cargamos algunas cosas para que se vea más sexy
#+begin_src emacs-lisp
  (use-package org
    :ensure nil
    :defer t)
...
Aqui cargamos algunas utilidades más para org-mode(se hace en un script diferente ya que son bastantes y asi mejoramos en eficiencia) y hacemos la instalacion de auto-tangle
#+begin_src emacs-lisp
...
#+end_src
*** Eldoc
Como es necesario para usar bien LSP se cargara a traves de eglot-setup
*** LSP
#+begin_src emacs-lisp
(require 'eglot-setup)
 #+end_src
...
#+end_src
*** Java
Movido a [[file:scripts/eglot-setup.el][Eglot setup]]
*** XML
Aquí irán algunas configuraciones para usar el lenguaje xml
#+BEGIN_SRC emacs-lisp
  
#+END_SRC
*** Dape
Esto nos permitira tener un depurador
#+begin_src emacs-lisp
   (use-package dape
     :defer t)
#+end_src
...
#+end_src
** Adaptative wrap
Hace que la sangria sea igual cuando es demasiado larga para mostrarse en pantalla
#+begin_src emacs-lisp
