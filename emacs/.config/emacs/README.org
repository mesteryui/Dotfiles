...
#+begin_src emacs-lisp :tangle lisp/tools.el :noweb yes
<<lexicalbind>>
...
Aqui pongo ajustes a ciertas herramientas nativas de Emacs que a lo mejor no es muy bueno poner con otras herramientas
*** Time
...
#+end_src
*** Jinx
Corrector ortográfico para Emacs usando la librería enchant, tambien permite la corrección al vuelo y es mejor que Flyspell.
#+begin_src emacs-lisp
(use-package jinx
  :ensure t
...
#+begin_src emacs-lisp :tangle lisp/lang/pythonlang.el :noweb yes
<<lexicalbind>>
(use-package uv
...
*** Scheme
:PROPERTIES:
:header-args:emacs-lisp: :tangle "lisp/lang/schemelang.el" :mkdirp yes
:END:
Lenguaje de programación bastante particular al que todavía no le he pillado todo
el potencial.
#+begin_src emacs-lisp :tangle lisp/lang/schemelang.el :noweb yes
<<lexicalbind>>
  (use-package geiser
  :ensure t)
...
#+end_src
*** Common Lisp
#+begin_src emacs-lisp :tangle lisp/lang/common-lisp.el :noweb yes
<<lexicalbind>>
  (use-package sly
    :ensure t
    :commands sly
...
#+begin_src emacs-lisp :tangle lisp/lang/emacs-lisp.el :noweb yes
<<lexicalbind>>
...
- [[https://protesilaos.com/][Protesilaos]] últimamente me he inspirado más en el por ejemplo en tenerlo todo en un archivo e ir sacando a varios tambien estoy usando fontaine y tengo cierto interes en tmr y logos.
