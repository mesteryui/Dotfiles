...
#+end_src
** Elpaca
El gestor de paquetes que utilizo
#+begin_src emacs-lisp
...
Este sistema de auto guardado es muy coñazo por los archivos que genera así que lo quito, y lo cambio por [[#autoguardado][Supersave]]
...
#+end_src
** Abrir configuración
Abrir la configuración la configuracion
#+begin_src emacs-lisp
...
#+end_src
** Eat
A usar en futuro proximo a lo mejor, la estoy probando
#+begin_src emacs-lisp
