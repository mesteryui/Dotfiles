...
#+end_src
**** Yuck
Lo pongo aqui porque el proposito de esta cosa es hacer interfaces no tanto programar además la parte de lenguajes de programacion ya esta muy llena 
#+begin_src emacs-lisp
...
#+end_src
** Outline
Permite estructurar el codigo en estructuras plegables siendo practico para codigo largo, con outline-indent puedo plegar el codigo en base a indentaciones.
#+begin_src emacs-lisp
(use-package outline
  :ensure nil
...
#+end_src
* Carga de archivos
Aquí defino el bloque de codigo que lleva a cabo la carga de todos los modulos que componen esta config
#+begin_src emacs-lisp :tangle init.el
...
- [[https://protesilaos.com/][Protesilaos]] ultimamente me he inspirado más en el por ejemplo en tenerlo todo en un archivo e ir sacando a varios.
