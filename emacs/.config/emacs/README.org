...
**** Tema Catppuccin
Tema bastante chulo aunque los temas de protesilaos tambien molan bastante.
#+begin_src emacs-lisp :tangle no
...
#+end_src
**** Tema ef
Temas ef de Protesilaos es bastante chulo, tienen bastantes colores y se ven genial en general. Además tiene opciones de personalización bastante buenas al poder configurar cosas como los encabezados en documentos org.
#+begin_src emacs-lisp 
...
#+RESULTS:
: [nil 26747 58584 101239 nil elpaca-process-queues nil nil 730000 nil]
