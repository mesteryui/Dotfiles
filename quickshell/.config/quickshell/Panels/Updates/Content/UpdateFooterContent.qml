...
Item {
    ...
    readonly property bool btnEnabled: !Services.UpdatesTracking.updating
        ...
        RowLayout {
            ...
            MaterialIcon {
                ...
                RotationAnimation on rotation {
                    ...
                    onRunningChanged: if (!running) btnIcon.rotation = 0
                }
            }

            Text {
                text: Services.UpdatesTracking.updating
                    ? Services.I18nService.getTranslation("update.updating")
                    : Services.UpdatesTracking.checking
                    ? Services.I18nService.getTranslation("update.checking")
